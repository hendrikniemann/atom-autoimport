...
import { findRootDir, findFiles } from './dir';
import { addImports } from './import';
import { flowCheckContents, findUnresolvedIdentifiers } from './flow';
import { nodeNativeModulePlugin, installedDependencyDefaultImportPlugin, flowNamedImportPlugin, projectFileDefaultImportPlugin } from './plugins';
  ...
  async import() {
    ...
    if (editor && pane) {
      ...
      for (let identifier of identifiers) {
        ...
        const imp = await [nodeNativeModulePlugin, installedDependencyDefaultImportPlugin, projectFileDefaultImportPlugin, flowNamedImportPlugin].reduce((previous, next) => {
